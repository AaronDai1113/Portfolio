    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
          As an experienced Software Development / IT Application Management with almost 10 years’ experiences of Manufacture/Automation Industry
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            I have gotten the recogniction from my customers/superiers due to my solid deliverable, my team could rely on me. 
          </p>
        </motion.div>
        {/* IMAGINATIVE */}
        <motion.div
